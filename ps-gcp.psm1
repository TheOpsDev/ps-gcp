<#
    Purpose: This module holds common functions used for interacting with gcloud commandline tool
...
<#
    .SYNOPSIS  
        This module holds common functions used for interacting with gcloud commandline tool
    .DESCRIPTION  
